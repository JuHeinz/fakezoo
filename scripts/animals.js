console.log("animal2.js connected");
...
var score = (size + immu + fert + life) / 4;
...
function write() {
    // Genetic Stats
    document.getElementById("idSpecies").innerHTML = animResult;
    document.getElementById("idSex").innerHTML = sexResult;
    document.getElementById("idName").innerHTML = namedResult;

    // Basic Info
    document.getElementById("idSize").innerHTML = size + "%";
    document.getElementById("idImmu").innerHTML = immu + "%";
    document.getElementById("idFert").innerHTML = fert + "%";
    document.getElementById("idLife").innerHTML = life + "%";
...
function write2 (){
    ...
    document.getElementById("idWarning").innerHTML = warning;


    // Pronomen für Text
    if (sexResult === "female") { pronoun = "her"; }
    else {
        pronoun = "his";
    }
    ...
    document.getElementById("idInfo").innerHTML = namedResult + flavorResult + " " + verdict;
    ...
    document.getElementById("idConservation").innerHTML = conservation;
...
function adoptionEffect() {
    ...
    document.getElementById("adoptionButton").disabled = true;

    //verstecke Modal Button
    var adoptionconfirm = document.getElementById("adoptionconfirm");
    adoptionconfirm.classList.add("diappearButton");

    // ändert Text in Modal
    document.getElementById("adoptionModalText").innerHTML = "Thank you so much!";
...
var gAnimal =
{
    ...
    longevity: life,
    generic_score: score,
    extinctionWarning: conservation,
    character: flavorResult,
    offspringWarning: warning,
    pronoun: pronoun,
    repopulationContribution: verdict
};
